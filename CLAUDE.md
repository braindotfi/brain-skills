...
Keep README and manifest language factual, search-friendly, and consistent.
Do not claim that the live MCP service or OAuth flow is ready until Phase 0 has
passed.
